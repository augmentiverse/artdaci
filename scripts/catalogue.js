...
const UI = {
  en: {
    ...
    reset: "Reset",
    results: "artworks",
    print: "Open printable artwork page",
    ar: "Image AR",
    space: "Room AR",
    ...
    years: "years covered",
    modes: "active modes",
    printFirst: "printable artwork pages",
    by: "by",
  ...
  fr: {
    ...
    reset: "Réinitialiser",
    results: "œuvres",
    print: "Ouvrir la page imprimable",
    ar: "AR image",
    space: "AR espace",
    ...
    modes: "modes actifs",
    printFirst: "pages d’œuvres imprimables",
    by: "par",
    dimensions: "Dimensions",
    location: "Lieu",
    palette: "Palette",
  ...
  ar: {
    ...
    reset: "إعادة الضبط",
    results: "لوحات",
    print: "فتح صفحة العمل القابلة للطباعة",
    ar: "واقع معزز",
    ...
    modes: "تجارب متاحة",
    printFirst: "صفحات أعمال قابلة للطباعة",
    by: "للفنان",
    dimensions: "الأبعاد",
    location: "الموقع",
    palette: "الألوان",
  ...
  return `
    <article class="artwork-card">
      ...
      <div class="artwork-content">
        <p class="eyebrow">${formatArtworkNumber(manifest.bookOrder, lang)}</p>
